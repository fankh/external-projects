...
- Name: e2e/phase11-2fa.spec.js >> Phase 11: Two-Factor Authentication (TOTP) >> 02 - Enable 2FA: Setup page displays QR code and secret
- Location: tests/e2e/phase11-2fa.spec.js:49:3
...
Call log:
  - waiting for locator('a:has-text("Enable 2FA"), button:has-text("Enable 2FA")').first()
