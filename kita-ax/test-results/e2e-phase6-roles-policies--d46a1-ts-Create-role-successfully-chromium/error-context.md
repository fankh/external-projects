...
- Name: e2e/phase6-roles-policies.spec.js >> Phase 6: Roles and Policies Management - Smoke Tests >> Create role successfully
- Location: tests/e2e/phase6-roles-policies.spec.js:80:3
