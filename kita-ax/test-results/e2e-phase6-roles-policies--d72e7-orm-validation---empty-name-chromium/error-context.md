...
- Name: e2e/phase6-roles-policies.spec.js >> Phase 6: Roles and Policies Management - Smoke Tests >> Role form validation - empty name
- Location: tests/e2e/phase6-roles-policies.spec.js:321:3
