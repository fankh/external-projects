...
ITEMS = [
    ("가드레일 엔진",
     ...
     "  (단계별 민감정보 필터링, 적대적 공격 방어, 서비스 거부 공격 대응, 응답 결과 변형)",
     24_000_000, "SEC-006"),
    ("콘텐츠 필터링",
    ...
    ("감사로그",
     ...
     6_000_000, "SEC-008"),
    ("설치 · 기술이전",
     "- AI 플랫폼 탑재 및 다중망(AI망 · 운영망 · 개발망 · DMZ · AI개발망) 설치 · 구성, 운영자 교육",
     8_000_000, "SEC-008"),
]
...
NOTE = (
    ...
    "SEC-008(AI 플랫폼 내 가드레일 탑재) 대응 범위에 대한 견적이며, "
    "각 항목의 대응 요건은 비고란에 표기하였습니다.\n"
    "   - 당사 KYRA AI Guardrail 제품을 모듈 단위 정액으로 산정하였으며, "
