...
| 파일 | 설명 | 형식 |
|------|------|------|
| `AI_SECURITY_PORTAL_PRODUCT_GUIDE.md` | 기술 제품 안내서 (전사 AI 보안 포털) | Marp 슬라이드 (16:9) |
...
```bash
# PDF
npx @marp-team/marp-cli AI_SECURITY_PORTAL_PRODUCT_GUIDE.md --pdf

# HTML
npx @marp-team/marp-cli AI_SECURITY_PORTAL_PRODUCT_GUIDE.md --html
```
