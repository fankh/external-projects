...
| `전사_IT보안_거버넌스포털_제품안내서.pdf` | 배포용 PDF (17p — 부록: 구현 데모 화면) | PDF (A4 landscape) |
| `images/` | 제품안내서 부록 스크린샷 (portal-web 실화면) | PNG |
...
5. **연동 & 공통 기반** — 시스템 연동(그룹웨어·인사/근태·자산관리) / 공통 기능·환경설정
...
import pathlib
html = pathlib.Path('전사_IT보안_거버넌스포털_제품안내서.html').resolve().as_uri()
with sync_playwright() as p:
    b = p.chromium.launch(); pg = b.new_page()
    pg.goto(html, wait_until='networkidle')
    pg.pdf(path='전사_IT보안_거버넌스포털_제품안내서.pdf',
