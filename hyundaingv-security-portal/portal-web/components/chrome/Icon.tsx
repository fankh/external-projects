...
/**
 * 인라인 SVG 아이콘 세트 — 내비·마커 전용. 유니코드 글리프/이모지 혼용(폰트·OS 별 렌더 편차,
 * ▤▣▦ 류의 식별 곤란)을 하나의 라인 아이콘 패밀리로 통일한다. 모두 24×24 viewBox·currentColor
 * 스트로크·1.75 두께로, 뉴트럴 그레이 팔레트를 그대로 상속한다(별도 색 없음).
 * 장식용이므로 aria-hidden — 인접 텍스트 라벨이 접근성 이름을 제공한다.
 */
const PATHS: Record<string, string> = {
  ...
  expense: '<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1Z"/><path d="M8 7h8"/><path d="M8 11h8"/><path d="M8 15h5"/>',
  ...
  // IT Request
  fileplus: '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7l-5-5z"/><path d="M14 2v5h5"/><path d="M12 12v6"/><path d="M9 15h6"/>',
  list: '<line x1="8" x2="21" y1="6" y2="6"/><line x1="8" x2="21" y1="12" y2="12"/><line x1="8" x2="21" y1="18" y2="18"/><line x1="3" x2="3.01" y1="6" y2="6"/><line x1="3" x2="3.01" y1="12" y2="12"/><line x1="3" x2="3.01" y1="18" y2="18"/>',
  layers: '<path d="M12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.83z"/><path d="m6.08 9.5-3.48 1.59a1 1 0 0 0 0 1.81l8.6 3.91a2 2 0 0 0 1.65 0l8.58-3.9a1 1 0 0 0 0-1.83l-3.48-1.59"/>',
  ...
  filetext: '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7l-5-5z"/><path d="M14 2v5h5"/><line x1="8" x2="16" y1="13" y2="13"/><line x1="8" x2="16" y1="17" y2="17"/><line x1="8" x2="10" y1="9" y2="9"/>',
  // 임직원 의식제고
  ...
  filesearch: '<path d="M14 2v5h5"/><path d="M4.5 12V4a2 2 0 0 1 2-2h8l5 5v3"/><circle cx="11.5" cy="16.5" r="2.5"/><path d="m13.3 18.3 2.2 2.2"/>',
  ...
  filecheck: '<path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7l-5-5z"/><path d="M14 2v5h5"/><path d="m9 15 2 2 4-4"/>',
  // 환경설정
  users: '<path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M22 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/>',
  // 사용자 그룹(구성원 부여) — user-plus 계열로 users 와 구분
  usergroup: '<path d="M14 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="8" cy="7" r="4"/><line x1="19" x2="19" y1="8" y2="14"/><line x1="22" x2="16" y1="11" y2="11"/>',
...
export function Icon({ name, size = 16, ...rest }: { name: string; size?: number } & Omit<SVGProps<SVGSVGElement>, 'name'>) {
