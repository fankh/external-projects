...
async function main() {
  ...
  const CONTENT = [
    ...
    ['/platform/integrations', 'ADMIN', ['연동 채널', '그룹웨어 메일', '자산관리시스템', 'mock-asset', '인사정보 즉시 동기화', 'portal.config.ts', '어댑터 계약 자가진단', '전 프로필 적합', 'erp-asset', 'gov-asset', '검증기 자기점검', '정상', '채널 id 유일']],
