...
const ROUTES = [
  ...
  '/compliance/education', '/compliance/inspection', '/compliance/security-review', '/compliance/risks', '/compliance/policies', '/compliance/dr', '/work/todo', '/work/approvals',
  '/settings/users', '/settings/menus', '/settings/permissions', '/settings/groups', '/settings/codes', '/settings/objects', '/settings/forms', '/settings/audit',
