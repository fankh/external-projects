...
const ACTION_TONE: Record<AuditAction, 'ok' | 'err' | 'info' | 'neutral' | 'warn'> = {
  ...
  '결재선 변경': 'warn', '연동 채널 변경': 'warn', '공통코드 변경': 'warn', '서약양식 개정': 'warn', '엑셀양식 변경': 'warn', '게시물 삭제': 'warn', '재택 대상자 변경': 'warn', '점검 기준 변경': 'warn', '인프라 자산 변경': 'warn', '메뉴권한 변경': 'warn', '재무 속보 등록': 'neutral', '재무 속보 수정': 'warn', '정산품의 삭제': 'warn',
