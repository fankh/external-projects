...
export type AuditAction =
  ...
  | '결재선 변경' | '연동 채널 변경' | '공통코드 변경' | '서약양식 개정' | '보안서약 대리등록' | '엑셀양식 변경' | '게시물 삭제' | '재택 대상자 변경' | '점검 기준 변경' | '인프라 자산 변경' | '메뉴권한 변경' | '사용자 그룹 변경' | '보안위반 등록' | '협력업체 서약 징구' | '보안담당자 지정' | '보안객체 변경' | '교육 이수 등록' | '재무 속보 등록' | '재무 속보 수정' | '정산품의 삭제' | '보안성 검토 완료' | '컴플라이언스 스냅샷'
