...
export const CHANNELS: ChannelBinding[] = [
  ...
  { id: 'groupware-approval', kind: 'approval', name: '그룹웨어 전자결재', transport: 'REST API', usage: '결재 상신 연동 (결재는 그룹웨어에서 확인) — 실구현 예정', adapterId: 'internal-approval', enabledByDefault: true, planned: true },
  { id: 'groupware-sso', kind: 'sso', name: '그룹웨어 SSO', transport: 'SAML', usage: 'SSO 인증 (IdP 어설션) — 실구현 예정', adapterId: 'mock-sso', enabledByDefault: true, planned: true },
