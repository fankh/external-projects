...
이번 주 미등록 자산 8건이 발견되었고, 이 중 위험도 높음은 3건입니다. 외부 공격표면에서는 미등록 노출 자산 5건이 확인되었으며 CVE가 확인된 자산이 2건 포함됩니다. 미인가 SaaS는 4종으로, 소유자 확인 후 편입 또는 차단 판정이 필요합니다. 인증·계정·SW 위생에서는 크리덴셜 노출 4건·휴면 계정 4건·미인가 SW 4건이 미조치 상태로, 보안담당의 제거·비활성화·소유자 확인 조치가 필요합니다.
...
_크리덴셜 노출 미조치 4 · 휴면 계정 미처리 4 · 미인가 SW 미조치 4_
...
- 편입 요청 0건 · 격리 요청 1건
- 외부 위협 미조치 — 크리덴셜 노출 4 · 휴면 계정 4 · 미인가 SW 4 · 다크웹 유출 4
- 결재 대기 9건
- 활성 탐지 채널 6/6
