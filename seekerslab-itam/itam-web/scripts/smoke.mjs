...
try {
  ...
  // 업체 정시 반환율(SLA) — 예상 반환일(eta) 이내 반환 비율. 시드 중부IT서비스 3건 중 2건 정시 → 67%(2/3). 업체 책임성 심화.
  check('수리 업체 성과: 업체 정시 반환율(SLA) 표기(중부IT서비스 67% · 2/3)', rtHtml.includes('정시 반환율') && rtHtml.includes('67%'))
