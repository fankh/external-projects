...
function seedExternal(): ExternalAsset[] {
  return [
    ...
    { id: 'EXT-2607-09', host: 'ct-active.seekerslab.co.kr', ip: '203.0.113.141', method: '인증서 투명성 (CT)', mode: 'Passive', alive: false, risk: '중간', firstSeen: '2026-08-10', state: '미확인', certIssuer: "Let's Encrypt R3", certValidUntil: addDays(today(), 75), note: 'CT 로그 신규 발급 인증서 — 유효기간 내, 생존 유력(능동 확인 대기)' },
