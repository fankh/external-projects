    ...
    <>
      ...
      <div className="cols c2">
        <div className="callout">
          <b>기존 인프라 재활용 우선.</b> NAC·EDR·프록시·AD 등 이미 보유한 시스템의 API·로그를 커넥터로 수집하는 것을
          기본으로 하여, 도입 초기부터 에이전트 추가 배포 없이 가시성을 확보합니다. 능동 스캔은 정책 협의 후 단계적으로 확대합니다.
        </div>
        <div className="callout">
          <b>스캔 안전장치.</b> 능동 스캔은 허용 시간대·대역·강도 정책 안에서만 자유롭게 실행되며, 창 밖 실행은
