...
export function NotificationLog({ dispatches, canExport, canManage, role, openable }: { dispatches: Dispatch[]; canExport?: boolean; canManage?: boolean; role: Role; openable?: string[] }) {
