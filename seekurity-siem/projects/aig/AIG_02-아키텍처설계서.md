...
flowchart LR
    ...
    subgraph DA["Data & Application"]
        NAC["NAC"]
        DBA["DB접근제어"]
    end
    subgraph CT["Collector Tier"]
        COL["Collector<br/>Parser · Normalizer"]
    end
    subgraph MT["Manager / Storage Tier"]
        MGR["Seekurity Manager<br/>Web UI · Detection · Correlation"]
        OS["OpenSearch Storage<br/>Hot / Warm / Cold"]
    end
    NS -- "Syslog" --> COL
    EP -- "Agent/API · Syslog" --> COL
    DA -- "Syslog" --> COL
    COL -- "TLS" --> MGR
    MGR --> OS
    style FW fill:#E3F2FD,stroke:#1565C0
    style VPN fill:#E3F2FD,stroke:#1565C0
    style IPS fill:#E3F2FD,stroke:#1565C0
    style EDR fill:#E8F5E9,stroke:#2E7D32
    style DLP fill:#E8F5E9,stroke:#2E7D32
    style NAC fill:#FFF3E0,stroke:#E65100
    style DBA fill:#FFF3E0,stroke:#E65100
    style COL fill:#EDE7F6,stroke:#4527A0
    style MGR fill:#FCE4EC,stroke:#AD1457
    style OS fill:#F1F8E9,stroke:#558B2F
```
