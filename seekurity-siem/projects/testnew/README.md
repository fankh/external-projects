# TESTNEW Seekurity SIEM 구축 프로젝트
...
| - | `workbooks/TESTNEW_SOW.xlsx` | 착수 |
| - | `workbooks/TESTNEW_일정표.xlsx` | 구축 |
| - | `workbooks/TESTNEW_Log연동설계.xlsx` | 설계 |
| - | `workbooks/TESTNEW_방화벽정책.xlsx` | 설계 |
| - | `presentations/TESTNEW_착수발표.pptx`, `Completion.pptx` | 착수/완료 |
