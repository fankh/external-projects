...
export const SCREEN_BY_NODE: Record<string, ScreenDef> = {
  ...
  'i18n-data': { screenId: 'i18n-data', code: 'M-13-2', title: '데이터 번역' },
  ...
  'plm-eco-ledger': { screenId: 'plm-eco-ledger', code: 'D-5L', title: '변경 이력 대장' },
    ...
    nodes: [
      {
        id: 'plm-root', label: 'Work Process', children: [
          ...
          { id: 'plm-eco-ledger', label: '변경 이력 대장 (D-5L)' },
    ...
    nodes: [
      ...
      },
      {
        id: 'code-product', label: 'Product Code', children: [
          ...
          { id: 'i18n-data', label: '데이터 번역 (M-13-2)' },
