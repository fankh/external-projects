...
- **이관 18/59 화면**: +dashboard(SSR 집계·Run분석·견적vs실적 차이위젯·부서Event). write 3(holidays·companies·inventory). 남음: cost-actual·milestone-add·part/price 편집·CPQ Run·CAD(CadSvg 포팅).
