...
- **이관 33/59 화면**: +process-defs·project-folder(project searchParam). write 4. 남음: design-editor·cad-viewer·CPQ Run(비동기)·bom-compare·sub-code·datatable(동적컬럼)·variant·tech-data·work-process·macro·ui-designer·templet·subcode 등. ※nginx 중지 중=빌드검증만.
