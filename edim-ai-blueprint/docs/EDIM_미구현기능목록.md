...
- [x] **다통화/환율 마스터 + 세금엔진 (v15.8)** — **alembic 0018**(fx_rate·tax_code) + 환율 CRUD(KRW 기준·통화별 최신·KRW 등록 422)·세금코드 CRUD(중복 409·세율 422)·세금엔진(POST /finance/quote-calc: 통화 금액→세액·합계 + 기준통화 KRW 환산·미등록 통화 422) + 다통화·세금 마스터 화면(M-13-1, ERP) 환율/세금 관리·세액 계산기. **E2E: live_g3_finance 13/13**. 견적 행별 통화·세액 자동적재 배선은 후속
