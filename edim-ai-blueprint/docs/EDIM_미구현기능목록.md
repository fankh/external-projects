...
- [ ] 폼 필드 방향키 이동 **[L]**
- [ ] 페이지네이션/가상화 · 공용 다중행 선택 · 컬럼 리사이즈/순서 · 인라인 편집 · 우클릭 메뉴 · 셀 복사 · 헤더 필터 **[M]**
- [ ] **페이지네이션/가상화** — 전 행 렌더(대용량 성능) **[H]**
- [ ] **공용 다중행 선택** — selectedKey 단일값, 화면별 수기 구현 → 공용 shift/ctrl·전체선택 표준화 **[H]**
- [ ] `Ctrl+S` 저장 · `Ctrl+F` 그리드 내 찾기 (현재 F12·⌘K 전역만) **[H]**
