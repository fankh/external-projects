...
- 결론: 4건 중 **3건 해소** — 코드 상세 단가(v13.18)·문서 상세 승인 영속(v13.19)·부품 상세 집계(v13.21). 잔여 **Work Process 자재행 1건**은 화면이 product_code 컨텍스트를 안 받는 구조라 코드 선택 + BOM 바인딩(UX+백엔드) **화면 재설계** — 별도 스프린트 권장.
