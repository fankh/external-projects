...
~~즐겨찾기~~ ✅ v20.4~20.5 · ~~대시보드 드릴다운~~ ✅ v20.4 · ~~감사 필터/XLSX~~ ✅ v20.4 · ~~Audit before/after 패널~~ ✅ v20.4 — 잔여:
F1 프로젝트 컨텍스트·CAD 뷰어(레이어 특성편집·편집 영속·축척 PDF·DXF 다운로드)·
...
- 좌측 패널 = 사용자 정의 목록(/prefs/leftnav, 기본=전체 권한 메뉴). D10 관리자 모듈 표시(sys_menu_config)와는 독립 — D10 Next 이식은 여전히 후속 항목.
