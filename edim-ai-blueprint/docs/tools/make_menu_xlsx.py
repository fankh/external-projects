...
MENUS = [
 ...
 ("M-14-11", "ERP", "Company Info.", "다국어 리소스 관리 (KO·EN·JA·ZH)", "-", "-", "SYS-021", "ADMIN", "P2", "번역 누락 검출·일괄 Export/Import"),
 ...
 ("M-15-7", "공통", "개인 설정", "색상·언어·판넬 화면 조정", "-", "E-1", "SYS-016/021", "전체", "P4", "슬라이드 57 — 색상·언어(4로케일)·판넬"),
