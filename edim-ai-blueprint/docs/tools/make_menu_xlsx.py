...
MENUS = [
 ...
 ("M-3-2", "Code(TLM) Set-up", "Code", "Sub Code Material", "W-04", "S-1-2", "CODE-005", "SETUP", "P1", ""),
 ...
 ("M-6-8", "ERP", "Sales", "출고 요청·고객 출고·납품 관리", "-", "§11", "ERP-009", "영업", "P5", ""),
 ...
 ("M-7-2", "ERP", "Tech.", "Part List (PL)·BOM", "-", "§11", "RUN-002/010", "기술", "P2", ""),
 ...
 ("M-8-3", "ERP", "Purchasing·Material", "자재 입고 (MI)·출고 (MO)", "-", "§11", "ERP-007", "자재", "P5", ""),
...
def main():
    ...
    info = [
        ("문서 버전", "v0.1"), ("작성일", "2026-07-07"),
        ("근거", "슬라이드 18 (H-1 Head System Set-Up 메뉴 맵), 56/59 (EDIM·ERP Toolbar), 기능정의서 v0.2"),
        ("메뉴 수", f"{len(MENUS)}개"),
