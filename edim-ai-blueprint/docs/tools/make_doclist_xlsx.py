...
DOCS = [
 ...
 # ---- 설계 ----
 ("설계", "컴포넌트(아키텍처) 정의서", "MD+Excel", "완료", "v0.2", "docs/EDIM_컴포넌트_정의서.md / EDIM_컴포넌트정의서.xlsx", "39컴포넌트·API 80·구축 상태 반영"),
 ("설계", "DB 정의서", "MD+Excel", "완료", "v0.2", "docs/EDIM_DB_정의서.md / EDIM_DB정의서.xlsx", "50테이블 435컬럼 — 보완노트 반영, duct_*는 범위 확정 후"),
...
def main():
    ...
    info = [
        ...
        ("우선 권고", "① 개발 표준 정의서 (P1 착수 전) ② 데이터 이행 계획서 (AI 학습과 연계, 조기 협의) ③ WBS 내용화"),
    ]
    r = 4
    for k, v in info:
