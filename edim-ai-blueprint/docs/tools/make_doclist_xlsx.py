...
DOCS = [
 ...
 ("설계", "디자인 시안 (Hi-Fi)", "HTML", "완료", "v0.1", "docs/EDIM_디자인시안.html · https://edim.seekerslab.com/design/hifi/", "디자인 시스템(토큰)+핵심 6페이지 — 개발 시 CSS 변수 이식"),
 ...
 ("구현·시험", "기능확인서 (FVT)", "Excel(자동)", "완료", "v0.1", "docs/03_기능확인서_FVT/EDIM_기능확인서.xlsx", "기능 178·비기능 22 자동 생성 — 판정 기입 후 버전 고정"),
...
def main():
    ...
    info = [
        ...
        ("우선 권고", "① 착수 문서(수행계획·위험대장·보안계획) ② 배치·보고서양식 정의서 ③ 운영·사용자 매뉴얼(안정화 단계)"),
    ]
    r = 4
    for k, v in info:
