...
DOCS = [
 ...
 # ---- 설계 ----
 ("설계", "컴포넌트(아키텍처) 정의서", "MD+Excel", "완료", "v0.2", "docs/EDIM_컴포넌트_정의서.md / EDIM_컴포넌트정의서.xlsx", "39컴포넌트·API 95·구축 상태 반영"),
 ("설계", "DB 정의서", "MD+Excel", "완료", "v0.2", "docs/EDIM_DB_정의서.md / EDIM_DB정의서.xlsx", "53테이블 451컬럼 — v0.3 설계 품질 리뷰(정규화·i18n·제약) 반영"),
