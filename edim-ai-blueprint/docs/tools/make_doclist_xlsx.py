...
DOCS = [
 ...
 ("이행·운영", "설치·배포 매뉴얼", "MD", "완료", "v0.1", "docs/EDIM_설치배포매뉴얼.md", "Self-managed 단일 서버 정식 절차(검증 구성 정본) + 검증 체크리스트 8·업그레이드/롤백·운영 확장(§8)"),
...
def main():
    ...
    info = [
        ...
        ("우선 권고", "① 현행분석·제안서(고객사·사업 조건 확정 후) ② 구현·시험 문서(테스트 계획·결함대장 — 본사업 병행) ③ 교육·검수 문서(안정화 단계) — 협의 불요 문서는 전량 완료(2026-07-11)"),
    ]
    r = 4
    for k, v in info:
