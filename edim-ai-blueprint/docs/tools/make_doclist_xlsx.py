...
DOCS = [
 ...
 # ---- 설계 ----
 ("설계", "컴포넌트(아키텍처) 정의서", "MD+Excel", "완료", "v0.2", "docs/EDIM_컴포넌트_정의서.md / EDIM_컴포넌트정의서.xlsx", "39컴포넌트·API 68·구축 상태 반영"),
 ("설계", "DB 정의서", "MD+Excel", "완료", "v0.1", "docs/EDIM_DB_정의서.md / EDIM_DB정의서.xlsx", "46테이블 — v0.2: 보완노트 후보 7테이블·물리 설계"),
 ...
 ("설계", "권한·승인 정의서", "Excel", "예정", "-", "-", "권한 매트릭스(역할×메뉴 97)·승인 상태기계"),
 ("설계", "개발 표준 정의서", "문서", "예정", "-", "-", "코딩·명명·Git·리뷰·API 규약 — P1 착수 전"),
...
def main():
    ...
    info = [
        ...
        ("우선 권고", "① 개발 표준 정의서·권한 정의서 (P1 착수 전) ② 데이터 이행 계획서 (AI 학습과 연계, 조기 협의) ③ WBS 내용화"),
    ]
    r = 4
    for k, v in info:
