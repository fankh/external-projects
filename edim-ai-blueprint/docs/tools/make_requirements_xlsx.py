...
FUNC = [
 ("시스템 공통", [
  ...
  ("REQ-F-006", "Main Work Frame", "Head Tab + 3판넬(좌 Tree·중앙 작업·우 Templet) 공통 화면, 일정·To-do·알림·업무 SNS·개인화", "필수", "P1~", "SYS-013~021", ""),
 ]),
 ("RCCS 코드", [
 ...
 ("ERP", [
  ...
  ("REQ-F-042", "Dashboard·마스터", "전후 공정·일정·이상 경고(시간/자금)·손익·자금 흐름 집계, 회사 마스터, 업체/Project 평가, 다국어(EN/JA/ZH) 라벨 검수", "필수", "P2~P5", "ERP-013~015", "다국어 라벨 검수 항목 추가 — 변경관리대장 No.2 (2026-07-25)"),
 ]),
 ("AI", [
...
NONFUNC = [
 ...
 ("REQ-N-015", "사용성", "다국어 (i18n)", "한국어 기본 + 영어·일본어·중국어 지원 — UI 리소스 번들 + 데이터 라벨 번역(sys_translation), 로케일별 날짜·숫자·통화 포맷, 번역 누락 시 KO 폴백", "4개 로케일(ko/en/ja/zh) 전환 100%", "확정 (2026-07-07)"),
...
def main():
    ...
    info = [
        ("문서 버전", "v0.2"),
        ("작성일", "2026-07-07"),
        ("개정", "v0.2 (2026-07-25) — REQ-F-042 다국어 라벨 검수 항목 추가 (변경관리대장 No.2)"),
