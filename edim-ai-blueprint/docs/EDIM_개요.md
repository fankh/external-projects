...
| 4 | **클래스 정의서** | DrawingDocument·Code·Macro·Hierarchy 등 도메인 모델 클래스 | §5, §8, §10 | 예정 |
| 5 | **인터페이스 정의서** | EDIM Run API 상세 스펙, ERP/Digital Twin 연계, Excel Import/Export | §6, §7.1 | 예정 |
| 6 | **권한·승인 정의서** | 사용자 권한 매트릭스, 승인 상태기계, Platform 승인 범위 | §2, §4 | 예정 |
