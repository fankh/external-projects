...
| 4 | **메뉴 정의서** | Head Tab 기준 90메뉴 (PPT 전수 대조 v0.2) (화면 ID·기능 ID·권한·Phase 매핑) — [`EDIM_메뉴정의서.xlsx`](EDIM_메뉴정의서.xlsx) | §4, §13 | ✅ v0.1 |
| 5 | **화면설계서** | 주요 화면 10종 와이어프레임 W-01~W-10 (설계 노트·기능 ID 연계) — [`EDIM_화면설계서.html`](EDIM_화면설계서.html) · 열람: https://edim.seekerslab.com/design/ | §4, §7 | ✅ v0.1 |
| 6 | **클래스 정의서** | DrawingDocument·Code·Macro·Hierarchy 등 도메인 모델 클래스 | §5, §8, §10 | 예정 |
| 7 | **인터페이스 정의서** | EDIM Run API 상세 스펙, ERP/Digital Twin 연계, Excel Import/Export | §6, §7.1 | 예정 |
| 8 | **권한·승인 정의서** | 사용자 권한 매트릭스, 승인 상태기계, Platform 승인 범위 | §2, §4 | 예정 |
