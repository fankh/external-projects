...
> B22 산출물 (2026-07-10). 설계 시점 OpenAPI(107 op) 와 구현(148 op)의 정합 기록.
...
| 구분 | 수 | 비고 |
|---|---|---|
| 구현 라우터 (edim.py `/api/v1`) | **148 op** | B1~B21 전 배치 반영 |
...
| cost·cpq (원가·견적·Run) | 11 | | users·auth·roles (인증·권한) | 13 |
| 기타 (검색·알림·이력·i18n·CAD·부품·자재·업체 등) | 45 | | | |
