...
| 설치·배포 매뉴얼 | [`EDIM_설치배포매뉴얼.md`](EDIM_설치배포매뉴얼.md) | v0.1 | MD | Self-managed 단일 서버 정식 절차·검증 체크리스트 8·업그레이드/롤백·운영 확장 |
| 사용자 매뉴얼 (가이드) | [`EDIM_사용자가이드.md`](EDIM_사용자가이드.md) | v0.1 | MD | 공통 조작(F-Key·탭·검색)·모듈별 안내·FAQ — GENERAL·SETUP 대상 |
| 운영자 매뉴얼 (가이드) | [`EDIM_관리자가이드.md`](EDIM_관리자가이드.md) | v0.1 | MD | 계정·권한·문서 통제·승인 운영·서버 운영·장애 대응 — ADMIN/PLATFORM 대상 |
...
4. ~~운영자·사용자 매뉴얼~~ · ~~설치·배포 매뉴얼~~ — ✅ 완료 (2026-07-11) · 현행분석서·제안서 (고객사·사업 조건 확정 후)
