...
| `live_cost_masking.py` | 원가·견적 열람 통제 일관성 — cost=masked/hidden 시 Run 원가·실적·PCR **전 경로** 마스킹, quote=no_download 시 PCR/견적서 **PDF 403**, ADMIN 은 실값·다운로드 유지, full 복귀 시 실값 복원 (검증용 견적·실적 자체 생성/정리) | 8.3 (#5·#6) |
