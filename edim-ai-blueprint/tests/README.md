...
| `live_toolbox_package.py` | Toolbox Package — 상태기계 건너뛰기 422·게시본 구성 변경 409·새 버전 복사·CRITICAL 가드 + **Sandbox 실패 시 전이 409·Runtime 활성 1개·Rollback 이력 보존** (자체 정리) | 5.6·5.8·6.0 (#56·#61·#62·#63) |
