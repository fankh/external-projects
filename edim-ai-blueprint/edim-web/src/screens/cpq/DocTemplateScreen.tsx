  ...
  return (
    <div className="fill-col">
      <div className="qband">
        ...
        <Combo width={130} value="밀도 계산서" options={['밀도 계산서', 'Fan 성능 Report']} />
        <span style={{ flex: 1 }} />
        <span style={{ fontSize: 10, color: 'var(--txt-mute)' }}>
          Form 정의: Document Set-up S-3-3 (CPQ-012)
        </span>
      </div>
      <div style={{ display: 'flex', gap: 6, flex: 1, minHeight: 0, padding: 6 }}>
        <div className="fill-col" style={{ gap: 6, flex: 1, overflow: 'auto' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 6, flex: 1, minHeight: 0 }}>
            <GroupBox title="습공기 선도 — 계산점 표시 (그래프 Templet)">
              <Cvs blocks={rho != null ? [{
        ...
        <div style={{ width: 290, display: 'flex', flexDirection: 'column', gap: 6, overflow: 'auto' }}>
          ...
          <GroupBox title="계산 참조 Table">
            <div style={{ fontSize: 11, lineHeight: 1.9 }}>
              psychro_const (Constant) <Chip tone="ok">승인</Chip><br />
              Table12 (Variant) <Chip tone="ok">승인</Chip>
            </div>
          </GroupBox>
        </div>
      </div>
