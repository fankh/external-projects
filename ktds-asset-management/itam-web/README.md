...
제품안내서가 정의한 **8대 업무 도메인의 명시 화면 28종**이 모두 구현되어 있다.
...
| **Discovery** | `/discovery/found` | 6채널 발견 자산 — 자산 지문 병합·관측 이력 · 소유자 확인/편입/격리 | §04 |
...
15. **원시 관측 → 지문 병합** — 6채널이 각자 본 관측을 지문(MAC→호스트명→IP)으로 합쳐 발견 목록을
