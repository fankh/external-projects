...
| `04_CUPIA_계약관리_시행세칙_2011-2024.txt` | 재단 「계약관리 시행세칙」 원문 (2011.2.22 제정, 2024.6.28 최종 개정). 계약 원칙(일반경쟁)·수의계약 요건(제33조)·보증금(제6조)·지체상금(제11조)·하자담보(제12조)·검수(제8조) — `08_계약관리/` 가이드라인의 근거 규정 |
...
├── README.md               ← 이 문서
└── docs/
    ├── 00_산출물관리/       ← 산출물_관리대장_v0.1.xlsx (필요 문서 44건 전수 목록·기한·검수 일정)
    ├── 01_제안서/           ← PROPOSAL_..._v0.3.pptx (라이트 컨설팅 스타일 12슬라이드 — 백색·헤어라인·틸 악센트)
    ...
    ├── 06_보고서/           ← 착수(4월)·중간(7월)·최종(12월) 보고서, 주간월간/ (작성 예정)
    ├── 07_회의록/           ← 회의록·협의 기록·변경 관리 (SOW 14조: 협의는 서면 기록)
    ├── 08_계약관리/         ← CONTRACT_GUIDE_..._v0.1.docx (재단 계약관리 시행세칙 적용 기준 — 계약 방식·보증금·지체상금·검수·매핑표·체크리스트)
    │                          JUSTIFICATION_수의계약_사유서_..._v0.1.docx (세칙 제33조 1항 1호 — 경쟁 불허·유리한 가격 논거, 대안 검토, 절차 요건, 근거자료 목록)
