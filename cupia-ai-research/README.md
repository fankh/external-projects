...
| `05_견적서_양식_씨커스_NSHC_20260421.xls` | 씨커스 견적서 표준 양식 (NSHC 제출본, 2026-04-21). 인력 기준·업무 기준 2시트, SW기술자 직무별 단가 체계 — CUPIA 견적서의 템플릿 |
...
└── docs/
    ...
    │                          [CUPIA] EWACS_복합_AI_Agent_구축_견적서_20260731.xlsx (과제2 한정 22 M/M·193,481,808원 VAT별도 — NSHC 양식 기반, 과제1은 수행 완료)
