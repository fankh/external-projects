...
**e-PASS AI 모델 상품화 + EWACS 복합 AI Agent 구축** — CUPIA(전자통관국제협력재단) × (주)씨커스 공동 연구 과제

| 항목 | 내용 |
|---|---|
| 발주기관 | 전자통관국제협력재단 (CUPIA) AI연구개발본부 |
| 수행업체 | (주)씨커스 (Seekers Inc.) |
...
| `05_견적서_표준양식_씨커스.xlsx` | 씨커스 견적서 표준 양식 (일반화 버전). 인력 기준·업무 기준 2시트, SW기술자 직무별 단가 체계 — CUPIA 견적서의 템플릿 |
| `06_AI_공동연구방안_CUPIA.pdf` | AI 공동 연구 방안 슬라이드 (13p). 과제 1·2 단계별 계획, 투입 인력 M/M(과제1 9·과제2 22), EWACS 아키텍처, AI-FDS 확장 사례, 협의 필요 사항 — SOW의 기초 자료 |
...
└── docs/
    ...
    │                          수의계약_사유서_..._v0.1.docx (세칙 제33조 1항 1호 — 경쟁 불허·유리한 가격 논거, 대안 검토, 절차 요건, 근거자료 목록)
    │                          [CUPIA] EWACS_복합_AI_Agent_구축_견적서_20260731_1.xlsx (인력 M/M 기준 — 5역할 22 M/M, 인건비 193,481,808 + 일반관리비 6% + 이윤 7.27%)
    │                          [CUPIA] EWACS_복합_AI_Agent_구축_견적서_20260731_2.xlsx (업무 모듈별 정액 기준 — 3모듈 33M/126M/61M) ※ 총액 동일 220,000,000원 VAT별도, 과제2 한정
    ├── 09_코드베이스분석/   ← CUPIA GitLab 코드베이스 분석 (내부 자료 — 저장소 149개 지형, 프레임워크·표준 정본, 과제 1·2 접점과 공백)
    ├── 10_구현계획/        ← 과제2 EWACS AI Agent — 구현 계획(단계·게이트·리스크) + 코드 구현 계획(저장소 구조·코드 규약·DB/이벤트 계약·수직 슬라이스)
