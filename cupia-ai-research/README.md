...
└── docs/
    ...
    │                          [CUPIA] EWACS_복합_AI_Agent_구축_견적서_20260731_1.xlsx (인력 M/M 기준 — 5역할 22 M/M)
    │                          [CUPIA] EWACS_복합_AI_Agent_구축_견적서_20260731_2.xlsx (업무 모듈별 정액 기준 — 3모듈) ※ 총액 동일 193,481,808원 VAT별도, 과제2 한정
